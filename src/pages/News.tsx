                ...
                <Card key={news.id} className="news-card overflow-hidden border border-gray-200">
                  ...
                  <CardHeader>
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-xs bg-primary text-white px-2 py-1 rounded-full">{news.newsType.name}</span>
                  ...
                  <CardContent>
                    {/* <p className="text-gray-600 line-clamp-3">{news.content.substring(0, 150) || "555"}...</p> */}
                  </CardContent>
                  <CardFooter>
